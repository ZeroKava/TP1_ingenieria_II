...
*   **Enlace al prototipo navegable:** [PEGA AQUÍ EL LINK DE FIGMA]
...
| :---: | :---: | :---: |
| ![Inicio](img/pantalla_inicio.png) | ![Formulario](img/pantalla_formulario.png) | ![Confirmacion](img/pantalla_confirmacion.png) |
